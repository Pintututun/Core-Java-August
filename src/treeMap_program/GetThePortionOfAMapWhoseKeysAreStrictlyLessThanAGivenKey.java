...
public class GetThePortionOfAMapWhoseKeysAreStrictlyLessThanAGivenKey {
public static void main(String[] args) {
	...
	System.out.println("Portion of map whose keys are strictly less than given key:"+map.headMap("C1"));
	System.out.println("Portion of map whose keys are strictly less than given key:"+map.headMap("C3"));
